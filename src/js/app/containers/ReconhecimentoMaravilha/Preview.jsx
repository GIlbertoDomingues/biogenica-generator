...
class Preview extends Component
{
    ...
    update()
    {
        ...
        const fileBackground = PIXI.Texture.fromImage(`/images/recm/sem_foto/${backgroundFilename}`);
    ...
    updateCategory(element, model, type)
    {
        ...
        element.style.align = settings.align;
        element.anchor.set(settings.anchor, 0);
        element.text =  selects.getLabelModelRecM(model).label.toUpperCase();
    }
