...
class Preview extends Component
{
    ...
    componentDidMount()
    {
        ...
        var loader = PIXI.loader
            .add('/images/rec/ruby-A.png')
            .add('/images/rec/ruby-B.png')
            .add('/images/rec/ruby.png')
            .add('/images/rec/emerald-A.png')
            .add('/images/rec/emerald-B.png')
            .add('/images/rec/emerald.png')
            .add('/images/rec/safira-A.png')
            .add('/images/rec/safira-B.png')
            .add('/images/rec/safira.png')
            .add('/images/rec/diamond-A.png')
            .add('/images/rec/diamond-B.png')
            .add('/images/rec/diamond.png')
            .add('/images/rec/diamond-blue-A.png')
            .add('/images/rec/diamond-blue-B.png')
            .add('/images/rec/diamond-blue.png')
            .add('/images/rec/diamond-black-A.png')
            .add('/images/rec/diamond-black-B.png')
            .add('/images/rec/diamond-black.png')
            .load( () => this.create() );
    }
    ...
    update()
    {
        ...
        const fileBackground = PIXI.Texture.fromImage(`/images/rec/${backgroundFilename}`);
    ...
    updateCategory(element, model, type)
    {
        ...
        element.style.align = settings.align;
        element.anchor.set(settings.anchor, 0);
        element.text =  selects.getLabelModelRec(model).label.toUpperCase();
    }
    ...
    updateAchive(element, model, type)
    {
        ...
        const fileAchive = PIXI.Texture.fromImage(`/images/rec/${model}.png`);
