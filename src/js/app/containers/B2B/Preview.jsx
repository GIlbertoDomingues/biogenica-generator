...
class Preview extends Component
{
    ...
    update()
    {
        const { template, type, bg, city, priceA, priceB, priceC, date, weekday, checkIn, place, address, photos, fontSize } = this.props.data;
        const color = (template === 'A' || template === 'B') ? colors.purple : colors.white;
...
console.log("update");
    ...
    canvasBg(bg)
    {
        const exists = this.elements.bg ? true : false;
        ...
        const file = PIXI.Texture.fromImage(`/images/b2b/background.png`);
    ...
    canvasBase(template, type)
    {
        ...
        const variant = 3;
        if(template == undefined){ template = "A";}
console.log("Typo:"+ variant);
console.log("templat:");
console.log(template);
        const file = PIXI.Texture.fromImage(`/images/b2b/template-bg-${template}${variant}.png`);
    ...
    canvasStatic(color, type, template)
    {
        const colortexto = (template === 'C') ? colors.white : colors.purple;
        if (!this.first){
        ...
        this.elements.box.beginFill(0xf47920)
                        .drawRect(43, 763, 7, 150)
                        .endFill();
        //checkin text
        ...
        */
        ...
        //add to stage
        this.app.stage.addChild(this.elements.box,
                                this.elements.check,
                                this.elements.prices,
    ...
    canvasPrice(priceA, priceB, priceC, color)
    {
